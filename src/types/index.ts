...
export interface ToastProps {
	...
	message?: string
	/**
	 * True if the message hide automatically, false if the user should have to interact with it. Defaults to true
	 */
	autoHide?: boolean
	/**
	 * Milliseconds before autoHide happens. Defaults to 4000
	 */
	...
	bottomOffset?: number
	/**
	 * friction value for the show/hide animation. Defaults to 8
	 */
	friction?: number
	/**
...
interface ToastContextSettings {
	...
	customToasts?: ToastComponentsConfig
	defaults: Required<Omit<ToastProps, keyof OptionalSettings>> & OptionalSettings
}
